...
def main():
    ...
    while rclpy.ok():
        try:
            ...
            moveit2.move_to_pose(position=[box1.transform.translation.x, box1.transform.translation.y, box1.transform.translation.z], quat_xyzw=[box1.transform.rotation.x, box1.transform.rotation.y, box1.transform.rotation.z, box1.transform.rotation.w], cartesian=False,tolerance_position = 0.03,tolerance_orientation=0.1)
